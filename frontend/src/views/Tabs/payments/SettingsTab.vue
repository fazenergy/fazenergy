    ...
    <div class="bg-white rounded border">
      <div class="p-3 flex items-start md:items-center justify-between gap-4">
        <div>
          ...
          <p class="text-[11px] text-gray-500">Parâmetros para efetuar pagamento via pix quando um licenciado solicitar pagamento.</p>
        </div>
        <button :disabled="saving" @click="onSave" class="px-3 py-1.5 rounded bg-blue-600 hover:bg-blue-700 text-white disabled:opacity-60 disabled:cursor-not-allowed">
...
<script setup>
// Aba de configurações gerais de Pagamentos (solicitação de saque)
