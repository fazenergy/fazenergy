    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, db_table='UserGroup', related_name='custom_user_set', to='auth.group', verbose_name='Grupo de Usuários')),
                ('user_permissions', models.ManyToManyField(blank=True, db_table='UserPermission', related_name='custom_user_set', to='auth.permission', verbose_name='Permissões')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('root_network_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='Nome Rede Raiz')),
                ('stt_record', models.BooleanField(default=True, verbose_name='Ativo')),
                ...
                ('dynamic_compression', models.BooleanField(default=False, verbose_name='Compressão Dinâmica Ativa')),
                ('dtt_record', models.DateTimeField(auto_now_add=True, verbose_name='Data Cadastro')),
                ('dtt_update', models.DateTimeField(auto_now=True, verbose_name='Data Atualização')),
