...
class Contractor(models.Model):
    ...
    # Preferências/últimos (removidos: preferred_property_type, last_electric_bill)
    # Status
...
class Proposal(models.Model):
    ...
    visit_1 = models.DateTimeField(null=True, blank=True, verbose_name='Visita 1 (agendamento)')
    visit_2 = models.DateTimeField(null=True, blank=True, verbose_name='Visita 2 (agendamento)')
...
class ProposalResult(models.Model):
    ...
    required_area = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True, verbose_name='Área Necessária (m²)')
